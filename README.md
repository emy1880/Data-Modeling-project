...
The database table codes have been attacched to this repository as [data_table_creation.sql](https://github.com/emy1880/Data-Modeling-project/blob/main/data_table_creation.sql). The database of choice for this project is Microsoft SQL Server
